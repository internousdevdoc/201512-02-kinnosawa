...
<div class="container">
    ...
    <div class="main">
        <div class="sidebar">
            ...
            <h3 class="sideMenu">ログイン</h3>
            <input type="button" value="マイページ" class="btn btn-success" style="margin-bottom:10px; width:80%"><br>
            <input type="button" value="ログアウト" class="btn btn-info" style="margin-bottom:10px; width:80%"><br>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body">
                ...
                <div class="text-left">
                    メールアドレス：<input type="text"placeholder="メールアドレスの入力">
                    パスワード：<input type="text"placeholder="パスワードの入力">
                <hr>
